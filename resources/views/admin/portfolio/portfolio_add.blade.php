                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('store.portfolio')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" placeholder="portfolio name" id="portfolio_name" name="portfolio_name">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" placeholder="portfolio title" id="portfolio_title" name="portfolio_title">
