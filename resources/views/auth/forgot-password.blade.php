                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    <img src="{{asset('')}}logo/logo.jpg" height="40" class="logo-dark mx-auto" alt="">
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="post" action="{{route('password.email')}}">
                                ...
                                <div class="alert alert-info alert-dismissible fade show" role="alert">
                                    Forgot your password? No problem. Just let us know your <strong> email </strong> address and we will email you a password reset link that will allow you to choose a new one.
