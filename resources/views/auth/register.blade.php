                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    <img src="{{asset('')}}logo/logo.jpg" height="50" class="logo-dark mx-auto" alt="">
                        ...
                        <div class="p-3">
                            <form method="post" class="form-horizontal mt-3" action="{{route('register')}}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input class="form-control" type="password" id="password_confirmation" name="password_confirmation" required="" placeholder="Password">
                                    </div>
                                </div>
